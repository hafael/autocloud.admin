    ...
    <div class="control-group">
      ...
      <div class="controls">
        <select id="anoFab" name="anoFab">
          <option value="<?=$this->anuncio_moto->AnoFab?>" selected><?=$this->anuncio_moto->AnoFab?></option>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <select id="anoMod" name="anoMod">
          <option value="<?=$this->anuncio_moto->AnoMod?>"><?=$this->anuncio_moto->AnoMod?></option>
        </select>
      </div>
    </div>
  ...
  <div class="span6 pull-right">
    ...
    <div class="control-group">
      <div class="controls">
        ...
        <input type="hidden" id="fabricanteText" name="fabricanteText" value="<?=$this->anuncio_moto->Montadora?>" alt="Montadora">
        ...
        <input type="hidden" id="TipoVeiculo" name="TipoVeiculo" value="<?=$this->anuncio->TipoVeiculo?>">
